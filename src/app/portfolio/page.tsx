          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Discover our most impactful projects, successful campaigns, and
                transformative brand stories that showcase our expertise in
                action.
              </p>
              ...
              <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  ...
                  <p className="text-blue-400 font-semibold">People Reached</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  <h3 className="text-3xl font-bold text-white mb-2">95%</h3>
                  <p className="text-indigo-400 font-semibold">Success Rate</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                  <h3 className="text-3xl font-bold text-white mb-2">25+</h3>
                  <p className="text-pink-400 font-semibold">Awards Won</p>
                </div>
              </div>
            </div>
          </div>
                      ...
                      >
                        {Object.entries(project.results)
                          ...
                          .map(([key, value], resultIndex) => (
                            <div key={resultIndex} className="text-center">
                              <h4 className="text-white font-bold">{value}</h4>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-200 text-lg mb-6 leading-relaxed">
                    How we transformed a traditional manufacturing company into
                    a digital-first sustainable brand, achieving record-breaking
                    engagement and sales growth within 6 months.
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-8">
                    <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                      ...
                      <p className="text-purple-400">ROI Increase</p>
                    </div>
                    <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                      <h4 className="text-3xl font-bold text-white mb-2">
                        2.1M
                      </h4>
                      <p className="text-blue-400">Total Reach</p>
                    </div>
                    <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                      <h4 className="text-3xl font-bold text-white mb-2">
                        15K+
                      </h4>
                      <p className="text-indigo-400">Quality Leads</p>
                    </div>
                    <div className="text-center p-4 bg-white/5 rounded-2xl border border-white/10">
                      <h4 className="text-3xl font-bold text-white mb-2">
                        6 Months
                      </h4>
                      <p className="text-pink-400">Timeline</p>
                    </div>
                  </div>
