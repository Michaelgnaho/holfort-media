          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
                Comprehensive digital media solutions designed to transform your
                brand and amplify your impact across all channels.
              </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        50+ brands transformed with measurable results and
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Cutting-edge strategies that leverage the latest
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Personal attention and customized solutions for every
