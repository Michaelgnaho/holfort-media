...
export default function Hero() {
  return (
    <div className="relative w-screen min-h-screen overflow-hidden">
      {/* Background Layer - Silk Animation (Optimized for mobile) */}
      <div className="absolute inset-0 z-0">
        <Silk
          speed={3} // Reduced speed for better mobile performance
          scale={1}
          color="#582EFF"
          noiseIntensity={1} // Reduced noise for smoother rendering
          rotation={0}
        />
      </div>
      ...
      <div className="relative z-20 flex flex-col lg:flex-row items-center justify-between w-full min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex-1 text-center lg:text-left mb-8 lg:mb-0">
          ...
          {/* CTA Buttons - Increased touch area */}
...
services"
            ...
            <Link
              href="/portfolio"
              className="inline-flex items-center bg-white/10 backdrop-blur-sm text-white font-semibold px-8 py-4 rounded-2xl border-2 border-white/20 hover:bg-white/20 transition-all duration-300 shadow-xl hover:shadow-2xl group touch-manipulation"
            >
      ...
      >
        <div className="absolute pt-10 bottom-8 left-1/2 transform -translate-x-1/2 z-20">
          <div className="text-center">
            <Link
              href="/contact"
              className="inline-flex items-center bg-white/10 backdrop-blur-sm text-white font-medium px-6 py-3 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300 text-sm group touch-manipulation"
            >
